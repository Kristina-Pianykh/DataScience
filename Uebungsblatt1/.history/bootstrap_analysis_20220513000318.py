...
def main():
    ...
    print(f"""
    Means:
        lower bounds of the 95%-confidence intervals: {mean_start}
        upper bounds of the 95%-confidence intervals: {mean_end}

    Standard error:
        lower bounds of the 95%-confidence intervals: {stddev_start}
        upper bounds of the 95%-confidence intervals: {stddev_end}
